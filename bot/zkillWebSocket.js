...
var discord = require('./discordClient.js');
         ...
         ws = new WebSocket(zKillAddress, {
          ...
          ws.on('message', function incoming(message) {
           ...
           //     http.get('https://zkillboard.com/ship/'+kill.victim.ship_type_id),
            ...
            /*     if(typeof alliance !== 'undefined') { discord.sendEmbeddedKillMessage(kill, character.data,corp.data,alliance.data) } 
                else
                {
                   
                    discord.sendEmbeddedKillMessage(kill, character.data,corp.data);
                } */
